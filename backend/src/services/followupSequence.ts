...
export const DEFAULT_TEMPLATES: Record<string, FollowUpTemplate[]> = {
  ...
  'pressure washing': [
    ...
    { day: 7, type: 'SMS', content: 'Hi {{name}}, our clients love their clean homes. Read our latest pressure washing reviews: [link]' },
    { day: 10, type: 'EMAIL', subject: 'Get ready for the weekend', content: 'Hi {{name}}, want your home sparkling for your next gathering? Book your pressure wash now for a discount...' },
    { day: 13, type: 'SMS', content: 'Hi {{name}}, the sun is out and we are busy! Reply YES to secure your spot for a home wash this week.' },
  ],
  cleaning: [
    ...
    { day: 8, type: 'SMS', content: 'Hi {{name}}, another home transformed! Our cleaners are the best in the business. Check out our work: [link]' },
    { day: 11, type: 'EMAIL', subject: 'Gift yourself some free time', content: 'Hi {{name}}, stop spending your weekends cleaning. We have a few new openings for weekly service...' },
    { day: 14, type: 'SMS', content: 'Hi {{name}}, we have one opening left for a deep clean this Friday. Reply YES to take it and save 10%!' },
  ],
  'lawn care': [
    ...
    { day: 7, type: 'SMS', content: 'Hi {{name}}, we make lawns look like golf courses. See our latest projects here: [link]' },
    { day: 10, type: 'EMAIL', subject: 'Start your lawn transformation', content: 'Hi {{name}}, fertilization season is here. Book your service now to ensure your lawn stays lush all summer...' },
    { day: 13, type: 'SMS', content: 'Hi {{name}}, our mowing routes are filling up! Reply YES to join our schedule and get your first mow free.' },
  ],
};
